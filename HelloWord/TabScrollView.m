...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UIView *uv = [[UIView alloc] initWithFrame:CGRectMake(0, 0, tabBarWidthSize-4, frame.size.height)];
        [sv addSubview:uv];
        sv.contentSize = uv.bounds.size;
        sv.showsHorizontalScrollIndicator = NO;
        [self addSubview:sv];
        
        UILabel *line = [[UILabel alloc] initWithFrame:CGRectMake(0, 30, frame.size.width, 5)];
